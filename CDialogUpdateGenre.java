...
public class CDialogUpdateGenre extends JDialog {
	 ...
	 * @param owner
	 */
	public CDialogUpdateGenre(Frame owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabel.setText("Введите новое название жанра");
		...
		if (jButtonOk == null) {
			...
			jButtonOk.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if(CData.UpdateNameGenre(CData.m_iSelectedIdGenre,jTextFieldNewGenreName.getText()))
					{
						JOptionPane.showMessageDialog(null, "Жанр успешно изменен!");
					...
					{
						JOptionPane.showMessageDialog(null, "Ошибка изменения жанра!");
					}
				}
			});
		}
